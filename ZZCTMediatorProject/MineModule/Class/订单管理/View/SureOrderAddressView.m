...
@interface SureOrderAddressView ()
...
@implementation SureOrderAddressView
...
- (void)initUI{
    ...
    [imageV mas_makeConstraints:^(MASConstraintMaker *make) {
     ...
     UILabel *addressLabel = [UILabel labelWithFont:Font_PingFang_SC_Medium(13) text:@"新建收货地址" textColor:rgb(53,53,53)];
