...
//    [self presentVC:nvc];
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"提示" message:@"请在IPhone的“设置-隐私-照片”中允许吉客优鲜访问您的照片" preferredStyle:(UIAlertControllerStyleAlert)];
    
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:nil];
    
    [alertController addAction:okAction];
    [self.sender presentViewController:alertController animated:YES completion:nil];
